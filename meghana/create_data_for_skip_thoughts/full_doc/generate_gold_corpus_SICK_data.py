...
def load_info(override=True):
	...
	dfile.write("pair_ID\tsentence_A\tsentence_B\trelatedness_score\tentailment_judgement\n")
	for x in range (0, 2701):
		if (x < 1351):
			afile.write(str(x) + "\t" + sentA[x] + "\t" + sentB[x] + "\t" + str(scoresAB[x]*1.0) + "\tblep\n")
			dfile.write(str(x) + "\t" + sentA[x] + "\t" + sentB[x] + "\t" + str(scoresAB[x]*1.0) + "\tblep\n")

		elif (x >= 1352 and x < 1486):
			bfile.write(str(x) + "\t" + sentA[x] + "\t" + sentB[x] + "\t" + str(scoresAB[x]*1.0) + "\tblep\n")
			dfile.write(str(x) + "\t" + sentA[x] + "\t" + sentB[x] + "\t" + str(scoresAB[x]*1.0) + "\tblep\n")
		
		else: 
			cfile.write(str(x) + "\t" + sentA[x] + "\t" + sentB[x] + "\t" + str(scoresAB[x]*1.0) + "\tblep\n")
			dfile.write(str(x) + "\t" + sentA[x] + "\t" + sentB[x] + "\t" + str(scoresAB[x]*1.0) + "\tblep\n")
